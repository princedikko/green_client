...
export default function AgentLogin() {
  ...
  const state = useSelector((state) => state.agentFunction);
  ...
  // FETCH DATA FM DB
  const [agentLoginData, setagentLoginData] = useReducer(
    (reqest, response) => {
  ...
  const executeLogin = async () => {
    const data = {
      user_name: agentLoginData.user_name,
      agent_password: agentLoginData.agent_password,
    };
    setLoaiding(true);
    await axios
      .post(
      ...
      .then((response) => {
        ...
        if (response?.data.status === 201) {
          ...
          redirect("/school-management/agent/account");
  ...
  const DispatchagentData = () => async (dispatch) => {
    try {
      dispatch(Action.startAgentAction({ agentData }));
    } catch (error) {
      console.log(error);
    }
  };
        ...
        <div className="management-login-container rwdG2">
          <div className="management-login-form-cont fx-cl space2">
            ...
            <div className="management-login-form fx-cl space3">
              <div className="fx-cl spacem">
                ...
                <div className="fx-ac space1">
                  ...
                  <input
                    ...
                    value={agentLoginData.user_name}
                    onChange={(event) =>
                      setagentLoginData({ user_name: event.target.value })
                    }
                    type="text"
              ...
              <div className="fx-cl spacem">
                ...
                <div className="fx-ac space1">
                  ...
                  <input
                    name="agent_password"
                    onKeyPress={handleKeyPress}
                    value={agentLoginData.agent_password}
                    onChange={(event) =>
                      setagentLoginData({
                        agent_password: event.target.value,
                      })
                    }
              ...
              {/* <button ><Link to="/agent_profile" style={{color: "white"}}>Login</Link></button> */}
              ...
              <button
                ...
                onClick={() => redirect("/agent_registration")}
              >
                Employment
              </button>
            </div>
          ...
          <div className="management-login-disc fx-cl fx-ac space4 rwdHide">
            <div className="fx-cl space2">
              <h4>Welcome back agent!, Let's get to Work</h4>
              <p style={{ fontSize: "1.6rem" }}>
                This Login is specifically for the agentistrative Staff of Manga
