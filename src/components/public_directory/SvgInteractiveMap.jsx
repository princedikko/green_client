...
import { nigeria, nigeriaText, worldMapsSvg } from "./interactiveSvgData.js";
...
export function WorldSvgInteractiveMap() {
          ...
          {worldMapsSvg?.map((state, index) => (
            <>
              <path
                ...
                onClick={() => handleModalSwitch(state?.country)}
              ></path>
            </>
          ))}
