...
import FilterCategories from "./filters/FilterExpenseCategory.jsx";
import ExportPDFButton from "./exports/ExpenseCategoryPDFExport.jsx";
import ExportExcelJSButton from "./exports/ExpenseCategoryExcelExport.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
export default function ExpenseCategory({ breadcrumbs }) {
  ...
  const totalPages = Math.ceil(expenseCateData?.length / rowsPerPage);
  const start = (currentPage - 1) * rowsPerPage;
  const end = start + rowsPerPage;
  const currentRows = expenseCateData?.slice(start, end);
  ...
  const apiGetExpenseCategory = async () => {
    setLoading(true);
    await axios
      .get(
      ...
      .then((response) => {
        expenseCateData = response.data.data;
        console.log("expenseCateData: ", response);
  ...
  function ToDo() {
    ...
    function CardView({ currentRows }) {
      return (
        <div className="categoriesxCardGrid g g4 space2">
          {currentRows?.map((item) => (
            <div key={item.invoiceNo} className="categoriesxGridCard">
              {/* Header */}
    ...
    return (
      <div className="fx-cl space2">
          ...
          <div className="fx-cl spacem">
            <div className="fx-ac fx-jb space2" style={{ fontSize: "1.2rem" }}>
              <span className="fx-ac spacem">
                ...
                <span>
                  {expenseCateData?.length === 0
                    ? "0 to 0 of 0 entries"
                    : `${start + 1} to ${Math.min(
                        end,
                        expenseCateData?.length,
                      )} of ${expenseCateData?.length} entries`}
                </span>
              </span>
              <div className="categoriesx_entries-info fx-ac spacem">
                <h4>Rows</h4>
                <div className="categoriesx-page-limit">
                  <button
                    className="categoriesx-page-limit-btn"
                    onClick={() => setOpenLimit(!openLimit)}
                  >
                    {rowsPerPage} / page
                    <span className="categoriesx-page-limit-arrow">▾</span>
                  </button>

                  {openLimit && (
                    <ul className="categoriesx-limit-dropdown">
                      {[10, 20, 50, 100, 200, 500, 1000].map((n) => (
                        <li
                          key={n}
                          className="categoriesx-limit-item"
                          onClick={() => {
                            setRowsPerPage(n);
                            setCurrentPage(1);
                            setOpenLimit(false);
            ...
            <div className="categoriesx_row" id="printable">
              {switchView()}
            </div>
            <div className="fx-jc">
              <div className="categoriesx_pagination fx-ac space2">
                <button
        ...
        <div className="categoriesx_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="categoriesx-airline fx-cl space1">
              <div className="categoriesx-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="categoriesx-airline-name">
                  Inventory Summation
                </div>
                <span className="categoriesx-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="categoriesx-flight-info fx-ac space2">
              <div className="categoriesx-time-block">
                <div className="categoriesx-time">12:10</div>
                <div className="categoriesx-location">
                  Moi Intl, Mombasa
                  <br />
                  Minna
                </div>
              ...
              <div className="categoriesx-flight-line fx-ac fx-jc space1">
                <FlightIcon className="categoriesx-plane-icon" />
                <div className="categoriesx-duration">3h 30min</div>
                <div className="categoriesx-stop">Non Stop</div>
              </div>

              <div className="categoriesx-time-block">
                <div className="categoriesx-time">15:30</div>
                <div className="categoriesx-location">
                  <PlaceIcon className="categoriesx-place-icon" />
            ...
            {/* RIGHT: Price */}
            <div className="categoriesx-price-section">
              <span className="categoriesx-cheapest">Cheapest</span>
              <div className="categoriesx-price">$110</div>
              <div className="categoriesx-class">Business Class</div>
              <button className="categoriesx-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  function Completed() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="categoriesx_footer">Footer here</div>
      </div>
    );
  }
  function Progress() {
  ...
  return (
    <div className="categoriesxCompContainer">
      <div className="fx-cl space2">
        ...
        <div className="categoriesx_headings fx-jb space4">
          <div className="fx-cl">
            <h2 style={{ textTransform: "capitalize" }}>
              {breadcrumbs.active_title}
            </h2>
            <p style={{ fontSize: "1.2rem" }}>
              Categories organize expenses into groups. This makes financial
              reporting easier.
              <br />| Category | Example Expenses | | Utilities | Electricity,
              Water | | Transport | Fuel, Logistics | | Salary | Staff wages | |
              Office | Internet, Printer ink | | Maintenance | Equipment repair
              |
            </p>
          </div>
        ...
        <div className="categoriesx_actionBar fx-jb space4">
          <ul className="left fx-ac">
            <li
              onClick={() => handleCurrentTAB("categoriesx")}
              className={`fx-ac  spacem ${
                currentTab == "categoriesx" && "active"
              }`}
            >
              <span>Todo</span>
              <figure>34</figure>
