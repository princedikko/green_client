...
import ExportExcelJSButton from "./exports/InvoicingExcelExport.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
export default function Invoicing({ breadcrumbs }) {
  ...
  const [invoicingFilterOpen, setinvoicingFilterOpen] = useState(false);
  ...
  async function apiPostInvoicing() {
    try {
      setLoading(true);
      const response = await axios.post(
        `${process.env.REACT_APP_SERVER_SCRIPT_HOST}/client/691a663dc9f64e6b9b8be48e/invoicing/post`,
        payload,
      );
  ...
  async function apiGetInvoicing() {
    setLoading(true);
    await axios
      .get(
  ...
  function ToDo() {
    ...
    function CardView({ currentRows }) {
      return (
        <div className="invoicingCardGrid g g4 space2">
          {currentRows?.map((item) => (
            <div key={item.invoiceNo} className="invoicingGridCard">
              {/* Header */}
    ...
    return (
      <div className="fx-cl space2">
          ...
          <div className="fx-cl spacem">
            <div className="fx-ac fx-jb space2" style={{ fontSize: "1.2rem" }}>
              ...
              <div className="invoicing_entries-info fx-ac spacem">
                <h4>Rows</h4>
                <div className="invoicing-page-limit">
                  <button
                    className="invoicing-page-limit-btn"
                    onClick={() => setOpenLimit(!openLimit)}
                  >
                    {rowsPerPage} / page
                    <span className="invoicing-page-limit-arrow">▾</span>
                  </button>

                  {openLimit && (
                    <ul className="invoicing-limit-dropdown">
                      {[10, 20, 50, 100, 200, 500, 1000].map((n) => (
                        <li
                          key={n}
                          className="invoicing-limit-item"
                          onClick={() => {
                            setRowsPerPage(n);
                            setCurrentPage(1);
                            setOpenLimit(false);
            ...
            <div className="invoicing_row" id="printable">
              {switchView()}
            </div>
            <div className="fx-jc">
              <div className="invoicing_pagination fx-ac space2">
                <button
        ...
        <div className="invoicing_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="invoicing-airline fx-cl space1">
              <div className="invoicing-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="invoicing-airline-name">
                  Inventory Summation
                </div>
                <span className="invoicing-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="invoicing-flight-info fx-ac space2">
              <div className="invoicing-time-block">
                <div className="invoicing-time">12:10</div>
                <div className="invoicing-location">
                  Moi Intl, Mombasa
                  <br />
                  Minna
                </div>
              ...
              <div className="invoicing-flight-line fx-ac fx-jc space1">
                <FlightIcon className="invoicing-plane-icon" />
                <div className="invoicing-duration">3h 30min</div>
                <div className="invoicing-stop">Non Stop</div>
              </div>

              <div className="invoicing-time-block">
                <div className="invoicing-time">15:30</div>
                <div className="invoicing-location">
                  <PlaceIcon className="invoicing-place-icon" />
            ...
            {/* RIGHT: Price */}
            <div className="invoicing-price-section">
              <span className="invoicing-cheapest">Cheapest</span>
              <div className="invoicing-price">$110</div>
              <div className="invoicing-class">Business Class</div>
              <button className="invoicing-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  function Completed() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="invoicing_footer">Footer here</div>
      </div>
    );
  }
  function Progress() {
    ...
    function TableView({ currentRows }) {
      return (
        <div className="prog">
          <button className="btnTemporary" onClick={() => apiPostInvoicing()}>
            Post Invoicing
          </button>
          <table className="fx-cl spacem">
            <thead className="fx-cl spacem">
            ...
            <div className="fx-ac space1">
              <button
                ...
                onClick={(e) => {
                  ...
                  setinvoicingFilterOpen(!invoicingFilterOpen);
                }}
              >
              ...
              {invoicingFilterOpen && (
                <div
                  className="invoicing_filter_modal_overlay fx-jc fx-ac"
                  onClick={() => setinvoicingFilterOpen(false)} // click outside → close
                >
                  <div
                    className="invoicing_filter_modal"
