...
export default function AddProduct() {
  ...
  return (
    <div id="createCont" className="g g2">
      <div className="fx-cl space2">
        ...
        <div className="fx-cl" style={{ gap: "12px", padding: "20px" }}>
          ...
          <input
            ...
            onChange={(e) =>
              setProductPayloads({ productType: e.target.value })
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              setProductPayloads({ description: e.target.value })
            }
          />
          <input
          ...
          <input
            ...
            onChange={(e) =>
              setProductPayloads({ batchBatchNo: e.target.value })
            }
          />
          <input
            type="number"
      ...
      <aside>
        ...
        voluptatibus perferendis vitae magni unde cum, laborum nobis, cupiditate
        pariatur, nam libero?
      </aside>
    </div>
  );
