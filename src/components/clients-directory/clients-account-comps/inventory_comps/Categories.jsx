...
import FilterCategories from "./filters/FilterCategories.jsx";
import ExportPDFButton from "./exports/CategoriesPDFExport.jsx";
import ExportExcelJSButton from "./exports/CategoriesExcelExport.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
export default function Categories({ breadcrumbs }) {
      ...
      <div className="fx-cl space2">
          ...
          <div className="fx-cl spacem">
            <div className="fx-ac fx-jb space2" style={{ fontSize: "1.2rem" }}>
              ...
              <div className="categories_entries-info fx-ac spacem">
                <h4>Rows</h4>
                <div className="categories-page-limit">
                  <button
                    className="categories-page-limit-btn"
                    onClick={() => setOpenLimit(!openLimit)}
                  >
                    {rowsPerPage} / page
                    <span className="categories-page-limit-arrow">▾</span>
                  </button>

                  {openLimit && (
                    <ul className="categories-limit-dropdown">
                      {[10, 20, 50, 100, 200, 500, 1000].map((n) => (
                        <li
                          key={n}
                          className="categories-limit-item"
                          onClick={() => {
                            setRowsPerPage(n);
                            setCurrentPage(1);
                            setOpenLimit(false);
            ...
            <div className="categories_row" id="printable">
              {switchView()}
            </div>
            <div className="fx-jc">
              <div className="categories_pagination fx-ac space2">
                <button
        ...
        <div className="categories_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="categories-airline fx-cl space1">
              <div className="categories-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="categories-airline-name">
                  Inventory Summation
                </div>
                <span className="categories-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="categories-flight-info fx-ac space2">
              <div className="categories-time-block">
                <div className="categories-time">12:10</div>
              ...
              <div className="categories-flight-line fx-ac fx-jc space1">
                <FlightIcon className="categories-plane-icon" />
                <div className="categories-duration">3h 30min</div>
                <div className="categories-stop">Non Stop</div>
              </div>

              <div className="categories-time-block">
                <div className="categories-time">15:30</div>
                <div className="categories-location">
                  <PlaceIcon className="categories-place-icon" />
            ...
            {/* RIGHT: Price */}
            <div className="categories-price-section">
              <span className="categories-cheapest">Cheapest</span>
              <div className="categories-price">$110</div>
              <div className="categories-class">Business Class</div>
              <button className="categories-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  function Completed() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="categories_footer">Footer here</div>
      </div>
    );
  }
  ...
  return (
    <div className="categoriesCompContainer">
      <div className="fx-cl space2">
        <div className="categories_breadcrumbs fx-ac">
        ...
        <div className="categories_headings fx-jb space4">
          <div className="fx-cl">
            <h2 style={{ textTransform: "capitalize" }}>
              {breadcrumbs.active_title}
            </h2>
            <p style={{ fontSize: "1.2rem" }}>
              Example supermarket categories: Category Drinks Snacks Dairy
        ...
        <div className="categories_actionBar fx-jb space4">
          <ul className="left fx-ac">
            <li
              onClick={() => handleCurrentTAB("categories")}
          ...
          <div className="right fx-ac fx-jb space1">
            <div className="fx-ac space1">
              <button
                className="categories_export_btn fx-ac spacem"
                onClick={(e) => {
              ...
              {categoriesFilterOpen && (
                <div
                  className="categories_filter_modal_overlay fx-jc fx-ac"
                  onClick={() => setcategoriesFilterOpen(false)} // click outside → close
                >
                  <div
                    className="categories_filter_modal"
