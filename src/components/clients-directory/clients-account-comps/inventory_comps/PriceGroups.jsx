...
import FilterPriceGroups from "./filters/FilterPriceGroups.jsx";
import ExportPDFButton from "./exports/PriceGroupPDFExport.jsx";
import ExportExcelJSButton from "./exports/PriceGroupExcelExport.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
export default function PriceGroups({ breadcrumbs }) {
  ...
  const [pricegroupsFilterOpen, setpricegroupsFilterOpen] = useState(false);
  ...
  function ToDo() {
    ...
    return (
      <div className="fx-cl space2">
            ...
            <div className="fx-cl spacem">
              ...
              >
                ...
                <div className="pricegroups_entries-info fx-ac spacem">
                  <h4>Rows</h4>
                  <div className="pricegroups-page-limit">
                    <button
                      className="pricegroups-page-limit-btn"
                      onClick={() => setOpenLimit(!openLimit)}
                    >
                      {rowsPerPage} / page
                      <span className="pricegroups-page-limit-arrow">▾</span>
                    </button>

                    {openLimit && (
                      <ul className="pricegroups-limit-dropdown">
                        {[10, 20, 50, 100, 200, 500, 1000].map((n) => (
                          <li
                            key={n}
                            className="pricegroups-limit-item"
                            onClick={() => {
                              setRowsPerPage(n);
                              setCurrentPage(1);
                              setOpenLimit(false);
              ...
              <div className="pricegroups_row" id="printable">
                {switchView()}
              </div>
              <div className="fx-jc">
                <div className="pricegroups_pagination fx-ac space2">
                  <button
        ...
        <div className="pricegroups_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="pricegroups-airline fx-cl space1">
              <div className="pricegroups-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="pricegroups-airline-name">
                  Inventory Summation
                </div>
                <span className="pricegroups-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="pricegroups-flight-info fx-ac space2">
              <div className="pricegroups-time-block">
                <div className="pricegroups-time">12:10</div>
                <div className="pricegroups-location">
                  Moi Intl, Mombasa
                  <br />
                  Minna
                </div>
              ...
              <div className="pricegroups-flight-line fx-ac fx-jc space1">
                <FlightIcon className="pricegroups-plane-icon" />
                <div className="pricegroups-duration">3h 30min</div>
                <div className="pricegroups-stop">Non Stop</div>
              </div>

              <div className="pricegroups-time-block">
                <div className="pricegroups-time">15:30</div>
                <div className="pricegroups-location">
                  <PlaceIcon className="pricegroups-place-icon" />
            ...
            {/* RIGHT: Price */}
            <div className="pricegroups-price-section">
              <span className="pricegroups-cheapest">Cheapest</span>
              <div className="pricegroups-price">$110</div>
              <div className="pricegroups-class">Business Class</div>
              <button className="pricegroups-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  function Completed() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="pricegroups_footer">Footer here</div>
      </div>
    );
  }
  function Progress() {
  ...
  return (
    <div className="pricegroupsCompContainer">
      <div className="fx-cl space2">
        <div className="pricegroups_breadcrumbs fx-ac">
        ...
        <div className="pricegroups_headings fx-jb space4">
          <div className="fx-cl">
            <h2 style={{ textTransform: "capitalize" }}>
              {breadcrumbs.active_title}
            </h2>
            <p style={{ fontSize: "1.2rem" }}>
              Price groups allow different prices for different customers.Retail
              ₦850 Wholesale ₦780 VIP ₦750
            </p>
          </div>
        ...
        <div className="pricegroups_actionBar fx-jb space4">
          ...
          <div className="right fx-ac fx-jb space1">
            <div className="fx-ac space1">
              <button
                className="pricegroups_export_btn fx-ac spacem"
                onClick={(e) => {
                  e.stopPropagation(); // stop bubbling to document
                  setpricegroupsFilterOpen(!pricegroupsFilterOpen);
                }}
              >
                <CandlestickChartIcon fontSize="large" />
                <span>Filter & Sort</span>
              </button>
              {pricegroupsFilterOpen && (
                <div
                  className="pricegroups_filter_modal_overlay fx-jc fx-ac"
                  onClick={() => setpricegroupsFilterOpen(false)} // click outside → close
                >
                  <div
                    className="pricegroups_filter_modal"
