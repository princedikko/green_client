...
import FilterDiscount from "./filters/FilterTaxRate.jsx";
import ExportPDFButton from "./exports/TaxRatePDFExport.jsx";
import ExportExcelJSButton from "./exports/TaxRateExcelExport.jsx";
...
import CreateTax from "./create/CreateTax.jsx";
...
export default function TaxRate({ breadcrumbs }) {
  ...
  const [taxrateFilterOpen, settaxrateFilterOpen] = useState(false);
  ...
  function TaxRates() {
    ...
    return (
      <div className="fx-cl space2">
          ...
          <div className="fx-cl spacem">
            <div className="fx-ac fx-jb space2" style={{ fontSize: "1.2rem" }}>
              ...
              <div className="taxrate_entries-info fx-ac spacem">
                <h4>Rows</h4>
                <div className="taxrate-page-limit">
                  <button
                    className="taxrate-page-limit-btn"
                    onClick={() => setOpenLimit(!openLimit)}
                  >
                    {rowsPerPage} / page
                    <span className="taxrate-page-limit-arrow">▾</span>
                  </button>

                  {openLimit && (
                    <ul className="taxrate-limit-dropdown">
                      {[10, 20, 50, 100, 200, 500, 1000].map((n) => (
                        <li
                          key={n}
                          className="taxrate-limit-item"
                          onClick={() => {
                            setRowsPerPage(n);
                            setCurrentPage(1);
                            setOpenLimit(false);
            ...
            <div className="taxrate_row" id="printable">
              {switchView()}
            </div>
            <div className="fx-jc">
              <div className="taxrate_pagination fx-ac space2">
                <button
        ...
        <div className="taxrate_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="taxrate-airline fx-cl space1">
              <div className="taxrate-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="taxrate-airline-name">Inventory Summation</div>
                <span className="taxrate-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="taxrate-flight-info fx-ac space2">
              <div className="taxrate-time-block">
                <div className="taxrate-time">12:10</div>
                <div className="taxrate-location">
                  Moi Intl, Mombasa
                  <br />
                  Minna
                </div>
              ...
              <div className="taxrate-flight-line fx-ac fx-jc space1">
                <FlightIcon className="taxrate-plane-icon" />
                <div className="taxrate-duration">3h 30min</div>
                <div className="taxrate-stop">Non Stop</div>
              </div>

              <div className="taxrate-time-block">
                <div className="taxrate-time">15:30</div>
                <div className="taxrate-location">
                  <PlaceIcon className="taxrate-place-icon" />
            ...
            {/* RIGHT: Price */}
            <div className="taxrate-price-section">
              <span className="taxrate-cheapest">Cheapest</span>
              <div className="taxrate-price">$110</div>
              <div className="taxrate-class">Business Class</div>
              <button className="taxrate-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  function TaxGroup() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="taxrate_footer">Footer here</div>
      </div>
    );
  }
  ...
  return (
    <div className="taxrateCompContainer">
      <div className="fx-cl space2">
        <div className="taxrate_breadcrumbs fx-ac">
        ...
        <div className="taxrate_headings fx-jb space4">
          <div className="fx-cl">
            <h2 style={{ textTransform: "capitalize" }}>
              {breadcrumbs.active_title}
            </h2>
            <p style={{ fontSize: "1.2rem" }}>
              This stores tax percentages applied to products.Tax Name Rate VAT
              7.5% Luxury Tax 10% Zero Tax 0%
            </p>
          </div>
        ...
        <div className="taxrate_actionBar fx-jb space4">
          <ul className="left fx-ac">
            <li
              onClick={() => handleCurrentTAB("taxrate")}
          ...
          <div className="right fx-ac fx-jb space1">
            <div className="fx-ac space1">
              <button
                className="taxrate_export_btn fx-ac spacem"
                onClick={(e) => {
                  e.stopPropagation(); // stop bubbling to document
                  settaxrateFilterOpen(!taxrateFilterOpen);
                }}
              >
              ...
              {taxrateFilterOpen && (
                <div
                  className="taxrate_filter_modal_overlay fx-jc fx-ac"
                  onClick={() => settaxrateFilterOpen(false)} // click outside → close
                >
                  <div
                    className="taxrate_filter_modal"
