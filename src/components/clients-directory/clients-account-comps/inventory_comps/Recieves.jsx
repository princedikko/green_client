...
import ExportExcelJSButton from "./exports/RecivesExcelExport.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
import InsertRecieve from "./create/InsertRecieves.jsx";

let recievesData;

export default function Recives({ breadcrumbs }) {
  ...
  const totalPages = Math.ceil(recievesData?.length / rowsPerPage);
  const start = (currentPage - 1) * rowsPerPage;
  const end = start + rowsPerPage;
  const currentRows = recievesData?.slice(start, end);
  ...
  async function apiFetchRecieves() {
    setLoading(true);
    await axios
      .get(
  ...
  function ToDo() {
    ...
    function CardView({ currentRows }) {
      return (
        <div className="recievesCardGrid g g4 space2">
          {currentRows?.map((item) => (
            <div key={item.invoiceNo} className="recievesGridCard">
              {/* Header */}
    ...
    return (
      <div className="fx-cl space2">
          ...
          <div className="fx-cl spacem">
            <div className="fx-ac fx-jb space2" style={{ fontSize: "1.2rem" }}>
              <span className="fx-ac spacem">
                ...
                <span>
                  {recievesData?.length === 0
                    ? "0 to 0 of 0 entries"
                    : `${start + 1} to ${Math.min(
                        end,
                        recievesData?.length,
                      )} of ${recievesData?.length} entries`}
                </span>
              </span>
              <div className="recieves_entries-info fx-ac spacem">
                <h4>Rows</h4>
                <div className="recieves-page-limit">
                  <button
                    className="recieves-page-limit-btn"
                    onClick={() => setOpenLimit(!openLimit)}
                  >
                    {rowsPerPage} / page
                    <span className="recieves-page-limit-arrow">▾</span>
                  </button>

                  {openLimit && (
                    <ul className="recieves-limit-dropdown">
                      {[10, 20, 50, 100, 200, 500, 1000].map((n) => (
                        <li
                          key={n}
                          className="recieves-limit-item"
                          onClick={() => {
                            setRowsPerPage(n);
                            setCurrentPage(1);
                            setOpenLimit(false);
            ...
            <div className="recieves_row" id="printable">
              {switchView()}
            </div>
            <div className="fx-jc">
              <div className="recieves_pagination fx-ac space2">
                <button
        ...
        <div className="recieves_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="recieves-airline fx-cl space1">
              <div className="recieves-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="recieves-airline-name">Inventory Summation</div>
                <span className="recieves-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="recieves-flight-info fx-ac space2">
              <div className="recieves-time-block">
                <div className="recieves-time">12:10</div>
                <div className="recieves-location">
                  Moi Intl, Mombasa
                  <br />
                  Minna
                </div>
              ...
              <div className="recieves-flight-line fx-ac fx-jc space1">
                <FlightIcon className="recieves-plane-icon" />
                <div className="recieves-duration">3h 30min</div>
                <div className="recieves-stop">Non Stop</div>
              </div>

              <div className="recieves-time-block">
                <div className="recieves-time">15:30</div>
                <div className="recieves-location">
                  <PlaceIcon className="recieves-place-icon" />
            ...
            {/* RIGHT: Price */}
            <div className="recieves-price-section">
              <span className="recieves-cheapest">Cheapest</span>
              <div className="recieves-price">$110</div>
              <div className="recieves-class">Business Class</div>
              <button className="recieves-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  function Completed() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="recieves_footer">Footer here</div>
      </div>
    );
  }
  useEffect(() => {
  ...
  return (
    <div className="recievesCompContainer">
      <div className="fx-cl space2">
        ...
        <div className="recieves_headings fx-jb space4">
          <div className="fx-cl">
            <h2 style={{ textTransform: "capitalize" }}>
              {breadcrumbs.active_title}
            </h2>
            <p style={{ fontSize: "1.2rem" }}>
              Receives means physically receiving goods from the supplier.
              Sometimes a purchase order is created first, but the goods arrive
              later.
            </p>
          </div>
        ...
        <div className="recieves_actionBar fx-jb space4">
          <ul className="left fx-ac">
            <li
              onClick={() => handleCurrentTAB("recieves")}
