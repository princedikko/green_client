...
import FilterUnits from "./filters/FilterUnits.jsx";
import ExportPDFButton from "./exports/UnitsPDFExport.jsx";
import ExportExcelJSButton from "./exports/UnitsExcelExport.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
import CreateUnit from "./create/CreateUnit.jsx";
...
export default function Units({ breadcrumbs }) {
  ...
  const [unitsFilterOpen, setunitsFilterOpen] = useState(false);
  ...
  function AllUnits() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="units_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="units-airline fx-cl space1">
              <div className="units-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="units-airline-name">Inventory Summation</div>
                <span className="units-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="units-flight-info fx-ac space2">
              <div className="units-time-block">
                <div className="units-time">12:10</div>
                <div className="units-location">
                  Moi Intl, Mombasa
                  <br />
                  Minna
                </div>
              ...
              <div className="units-flight-line fx-ac fx-jc space1">
                <FlightIcon className="units-plane-icon" />
                <div className="units-duration">3h 30min</div>
                <div className="units-stop">Non Stop</div>
              </div>

              <div className="units-time-block">
                <div className="units-time">15:30</div>
                <div className="units-location">
                  <PlaceIcon className="units-place-icon" />
            ...
            {/* RIGHT: Price */}
            <div className="units-price-section">
              <span className="units-cheapest">Cheapest</span>
              <div className="units-price">$110</div>
              <div className="units-class">Business Class</div>
              <button className="units-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="unitsCompContainer">
      <div className="fx-cl space2">
        <div className="units_breadcrumbs fx-ac">
        ...
        <div className="units_headings fx-jb space4">
          <div className="fx-cl">
            <h2 style={{ textTransform: "capitalize" }}>
              {breadcrumbs.active_title}
            </h2>
            <p style={{ fontSize: "1.2rem" }}>
              Units define how products are measured.Unit Meaning Piece single
              item Kg kilogram Liter liquid measure Pack group of items Carton
              large package
            </p>
          </div>
        ...
        <div className="units_actionBar fx-jb space4">
          ...
          <div className="right fx-ac fx-jb space1">
            <div className="fx-ac space1">
              <button
                className="units_export_btn fx-ac spacem"
                onClick={(e) => {
                  e.stopPropagation(); // stop bubbling to document
                  setunitsFilterOpen(!unitsFilterOpen);
                }}
              >
              ...
              {unitsFilterOpen && (
                <div
                  className="units_filter_modal_overlay fx-jc fx-ac"
                  onClick={() => setunitsFilterOpen(false)} // click outside → close
                >
                  <div
                    className="units_filter_modal"
