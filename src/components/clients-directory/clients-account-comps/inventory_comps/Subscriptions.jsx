...
import FilterSubscription from "./filters/FilterSubscriptions.jsx";
import ExportPDFButton from "./exports/SubscriptionPDFExport.jsx";
import ExportExcelJSButton from "./exports/SubscriptionExportExcel.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
export default function Subscriptions({ breadcrumbs }) {
  const { id } = useParams();
      ...
      <div className="fx-cl space2">
            ...
            <div className="fx-cl spacem">
              ...
              >
                ...
                <div className="subscription_entries-info fx-ac spacem">
                  <h4>Rows</h4>
                  <div className="subscription-page-limit">
                    <button
                      className="subscription-page-limit-btn"
                      onClick={() => setOpenLimit(!openLimit)}
                    >
                      {rowsPerPage} / page
                      <span className="subscription-page-limit-arrow">▾</span>
                    </button>

                    {openLimit && (
                      <ul className="subscription-limit-dropdown">
              ...
              <div className="subscription_row" id="printable">
                {switchView()}
              </div>
              <div className="fx-jc">
                <div className="subscription_pagination fx-ac space2">
                  <button
        ...
        <div className="subscription_footer">
          <div className="flight-card clientDashboardCard fx-jb fx-ac space2">
            {/* LEFT: Airline */}
            <div className="subscription-airline fx-cl space1">
              <div className="subscription-airline-logo fx-ac fx-jc">✈️</div>
              <div className="fx-cl space3">
                <div className="subscription-airline-name">
                  Inventory Summation
                </div>
                <span className="subscription-refund-badge">soled stuff</span>
              </div>
            </div>

            {/* CENTER: Flight info */}
            <div className="subscription-flight-info fx-ac space2">
              <div className="subscription-time-block">
                <div className="subscription-time">12:10</div>
              ...
              <div className="subscription-flight-line fx-ac fx-jc space1">
                <FlightIcon className="subscription-plane-icon" />
                <div className="subscription-duration">3h 30min</div>
                <div className="subscription-stop">Non Stop</div>
              </div>

              <div className="subscription-time-block">
                <div className="subscription-time">15:30</div>
                <div className="subscription-location">
                  <PlaceIcon className="subscription-place-icon" />
            ...
            <div className="subscription-price-section">
              <span className="subscription-cheapest">Cheapest</span>
              <div className="subscription-price">$110</div>
              <div className="subscription-class">Business Class</div>
              <button className="subscription-book-btn">Book Now</button>
            </div>
          </div>
        </div>
      </div>
  ...
  function Completed() {
    ...
    return (
      <div className="fx-cl space2">
        ...
        <div className="subscription_footer">Footer here</div>
      </div>
    );
  }
  function Progress() {
  ...
  return (
    <div className="subscriptionCompContainer">
      <div className="fx-cl space2">
        ...
        <div className="subscription_headings fx-jb space4">
          <div className="fx-cl">
            <h2 style={{ textTransform: "capitalize" }}>
              {breadcrumbs.active}
            </h2>
            <p style={{ fontSize: "1.2rem" }}>
              Here is a list of subscription you have made
            </p>
          </div>
        ...
        <div className="subscription_actionBar fx-jb space4">
          <ul className="left fx-ac">
            <li
              onClick={() => handleCurrentTAB("subscription")}
