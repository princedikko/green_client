...
import FilterCategories from "./filters/FilterCategoriesX.jsx";
import ExportPDFButton from "./exports/CategoriesXPDFExport.jsx";
import ExportExcelJSButton from "./exports/CategoriesXExcelExport.jsx";
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
export default function CategoriesX({ breadcrumbs }) {
  const { id } = useParams();
        ...
        <div className="categoriesx_headings fx-jb space4">
          <div className="fx-cl">
            ...
            <p style={{ fontSize: "1.2rem" }}>
              Here is a list of categoriesx you have made
            </p>
          </div>
