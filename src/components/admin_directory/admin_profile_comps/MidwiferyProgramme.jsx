...
function TableView() {
  return (
    <table className="couresOfStudyTable fx-cl spacem">
...
export default function MidwiferyProgramme() {
  ...
  async function getMidWiferyCourses() {
    setLoading(true);
    await axios
      .get(
        `${process.env.REACT_APP_SERVER_SCRIPT_HOST}/getMidWiferyCourses/administrative`
      )
      .then((response) => {
            ...
            <header className="fx-ac fx-jb space4">
              ...
              <div className="fx-ac space1">
                <span onClick={() => setChangeView("table")}>
                  <TocOutlinedIcon
                    style={{ fontSize: "3.4rem", color: "#ddd" }}
                  />
                </span>
